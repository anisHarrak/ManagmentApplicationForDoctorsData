...
.div_near_spacer {
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
     ...
     <title>edit Assure</title>
     
    </head>
<body>

<rich:panel>
		        <f:facet name="header" ><h:outputText value="Modifier Un Assuré"/></f:facet>
     <h:panelGrid>
     <h:form>
           <rich:layout>
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Nom assuré:" />
			...
			<h:inputText id="nom" value="#{assureCtrl.editAssure.nom_assure}"
				required="false" >
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Prénom assuré:" />
			...
			<h:inputText id="prenom" value="#{assureCtrl.editAssure.prenom_assure}"
				required="false" >
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Matricule assuré:" />
			...
			<h:inputText id="matricule" value="#{assureCtrl.editAssure.matricule_assure}"
				required="false" >
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Code caisse:" />
			...
			<h:inputText id="codecaisse" value="#{assureCtrl.editAssure.code_caisse}"
				required="false" >
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Date de naissance:" />
			<a4j:outputPanel id="datenaisance" layout="block">
                    <rich:calendar value="#{assureCtrl.editAssure.date_naissance}"
                        locale="fr/FR"
                        popup="true"
                        datePattern="d/MMM/y"
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Adresse assuré:" />
			...
			<h:inputText id="adresse" value="#{assureCtrl.editAssure.adresse}"
				required="false" >
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Numéro téléphone:" />
			...
			<h:inputText id="numtel" value="#{assureCtrl.editAssure.num_tel}"
				required="false" >
            ...
            <h:commandButton  value="Mettre à jour" action="#{assureCtrl.updateAssure}" />
