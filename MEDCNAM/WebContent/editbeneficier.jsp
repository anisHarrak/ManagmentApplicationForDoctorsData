...
.div_near_spacer {
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
     ...
     <title>edit Beneficier</title>
     
    </head>
<body>

<rich:panel>
		        <f:facet name="header" ><h:outputText value="Modifier Un Bénéficier"/></f:facet>
     <h:panelGrid>
     <h:form>
           <rich:layout>
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Nom bénéficier:" />
			...
			<h:inputText id="nom" value="#{beneficierCtrl.editBeneficier.nom}"
				required="false" >
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Prénom Bénéficier:" />
			...
			<h:inputText id="prenom" value="#{beneficierCtrl.editBeneficier.prenom}"
				required="false" >
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Rang malade:" />
			...
			<h:inputText id="rang" value="#{beneficierCtrl.editBeneficier.rang_malade}"
				required="false" >
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Lien parenté:" />
			...
			<h:inputText id="lienparente" value="#{beneficierCtrl.editBeneficier.lien_parente}"
				required="false" >
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Date de naissance:" />
			<a4j:outputPanel id="datenaisance" layout="block">
                    <rich:calendar value="#{beneficierCtrl.editBeneficier.date_naissance}"
                        locale="fr/FR"
                        popup="true"
                        datePattern="d/MMM/y"
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Adresse assuré:" />
			...
			<h:inputText id="adresse" value="#{beneficierCtrl.editBeneficier.adresse}"
				required="false" >
	...
	font-size:14px; text-decoration: none font-weight: bold;" value="Numéro téléphone:" />
			...
			<h:inputText id="numtel" value="#{beneficierCtrl.editBeneficier.num_tel}"
				required="false" >
          ...
          <h:commandButton  value="Mettre à jour" action="#{beneficierCtrl.updateBeneficier}" />
